...
def run_svm_project(attempt):
    ...
    w, b = svm(train_data, rate, c, epoch=10)


    with open("data/submissions/SVM_" + str(attempt) + ".csv", "w") as submission_file:
...
# run_svm()
# experiment_svm_project()
attempt = 0
run_svm_project(attempt)
